...
//               {[ 
//                 { name: t.nav.umrahPackages, path: '/umrah-packages' },
//                 { name: t.nav.ziyaratTours, path: '/ziyarat' },
//                 { name: t.nav.localTours, path: '/local-tours' },
//                 { name: t.nav.internationalTours, path: '/international-tours' },
...
//                 ].map((link) => (
//                   <li key={link.name}>
//                     <Link to={link.path} className="text-primary-foreground/80 hover:text-gold transition-colors">
//                       {link.name}
//                     </Link>
//                   </li>
//                 ))}
