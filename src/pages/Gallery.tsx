...
//     <SectionHeading
//       badge={t.gallery.faqBadge}
//       title={t.gallery.faqTitle}
//       subtitle={t.gallery.faqSubtitle}
//     />
...
//             animate={{ opacity: 1 }}
//             exit={{ opacity: 0 }}
//             className="fixed inset-0 z-50 flex items-start justify-center bg-primary/95 backdrop-blur-sm p-4 pt-24"
//             onClick={() => setSelectedIndex(null)}

//           >
//             <button
//               className="absolute top-28 right-6 w-12 h-12 rounded-full bg-primary-foreground/10 flex items-center justify-center text-primary-foreground hover:bg-primary-foreground/20 transition-colors"
//               onClick={() => setSelectedIndex(null)}
