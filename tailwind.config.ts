  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "sky-blue-pale": "hsl(var(--sky-blue-pale))",
        gold: "hsl(var(--gold))",
      ...
      boxShadow: {
        "glass": "0 4px 20px hsl(215 80% 18% / 0.08)",
        "glass-lg": "0 8px 40px hsl(215 80% 18% / 0.08)",
        "glow": "0 0 40px hsl(200 85% 55% / 0.25)",
        "glow-gold": "0 0 40px hsl(42 75% 55% / 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
